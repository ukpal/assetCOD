...
class ModuleController extends Controller
{
    ...
    {
        $modules = Module::get();
        $title = 'AssetCOD | Modules';
        return view('Administrator.Modules.index',compact('modules','title'));
    }

    public function createModule()
    {
        $title = 'AssetCOD | Create Modules';
        return view('Administrator.Modules.create_module',compact('title'));
    }
    ...
    {
        $title = 'AssetCOD | Edit Modules';
        if (!empty($module)) {
            return view('Administrator.Modules.edit_module', compact('module','title'));
        } else {
            return view('Administrator.Modules.edit_module', compact('module','title'));
        }
    }
